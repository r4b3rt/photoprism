      ...
      <v-card>
          ...
          <v-card-text class="dense">
            <v-row align="start" dense>
              <v-col cols="12" class="text-subtitle-2">
                {{ $gettext(`After entering your password for confirmation, you can set up two-factor authentication with a compatible authenticator app or device:`) }}
              </v-col>
              <v-col cols="12">
                <v-text-field
                  v-model="password"
              ...
              <v-col cols="12" class="text-body-2">
                {{ $gettext(`Enabling two-factor authentication means that you will need a randomly generated verification code to log in, so even if someone gains access to your password, they will not be able to access your account.`) }}
              </v-col>
            </v-row>
          </v-card-text>
        ...
        <template v-else-if="page === 'activate'">
          <v-card-text class="dense">
            <v-row align="start" dense>
              <v-col cols="12" class="text-body-2">
                {{ $gettext(`Use the following recovery code to access your account when you are unable to generate a valid verification code with your authenticator app:`) }}
              </v-col>
              <v-col cols="12">
                <v-text-field
